...
\begin{document}
	...
	\section*{Other errors found}
		...
		\paragraph{Page 31, Proof of Corollary 3.26.} $h$ and $g$ should be exchanged in the left hand side of the calculation, that is it should be \begin{align*}
			...
			&= \rho_h \cdot \rho_g.
		\end{align*}
		Also further down, $\varphi$ should be $\rho_h$, ie. it should be $\rho_h (\vvec) = \lambda\id \cdot \vvec$, that is the action of $\rho_h$ on an arbitrary $\vvec \in V$ changes $\vvec$ by a scalar factor.
