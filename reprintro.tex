...
The main purpose of this text is to study linear representations of groups, or in other words, studying groups and identifying them with vector spaces and their elements with maps of those spaces. Only finite groups and finite-dimensional vector spaces will be discussed in this text.
...
\begin{notation}
	A vector space $V$ provided with such a homomorphism discussed above is said to be a \textit{representation space} of $G$, allowing us to focus on the space itself\footnote{In fact, this gives $V$ the structure of a $G$-module \cite[1.3]{Sagan}.}.
\end{notation}
