...
Let $G$ be a finite group written multiplicatively. Denote its size by $|G|$ and the action of its elements with $\cdot$, eg. $g \cdot x$, sometimes shorted to $gx$.
...
\begin{notation}
	A vector space $V$ provided with such a homomorphism discussed above %fulfilling Equations \ref{eq:DefRepr}, \ref{eq:homomorphism} and \ref{eq:rhoIdAndInv}
