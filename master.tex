...
\paragraph{Morphisms of representations}
	...
	\begin{proof}
		...
		\end{align*}
		thus the image of $\bar{\pi}$ is in isomorphic correspondence with the elements of $W$, and hence also the elements of $V$.
		
		
		Consider how $\rho_g \circ \pi \circ \rho_g^{-1}$ acts on 
